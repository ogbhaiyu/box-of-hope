    ...
    <div className="scroll-modal-overlay">
      <div className="scroll-modal-content">
        ...
        <div className="scroll-actions">
          <button className="scroll-action-btn share" onClick={() => setShowShareMenu(true)}>
            🔗 Share this Reminder
          </button>
      ...
      {showShareMenu && (
        <div className="share-menu-overlay" onClick={() => setShowShareMenu(false)}>
          <div className="share-menu-card" onClick={(e) => e.stopPropagation()}>
            ...
            <button className="share-back-btn" onClick={() => setShowShareMenu(false)}>
              Back to Scroll
            </button>
          </div>
        </div>
